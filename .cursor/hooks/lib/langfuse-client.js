/**
 * Módulo do cliente Langfuse.
 * Inicializa o SDK e gerencia traces, sessões e scores.
 */
...
export function addCompletionScores(trace, input) {
  ...
  if (typeof input.loop_count === 'number') {
    ...
    addScore(trace, 'efficiency', efficiencyScore, `Completed in ${input.loop_count} loops`);
  }
}
