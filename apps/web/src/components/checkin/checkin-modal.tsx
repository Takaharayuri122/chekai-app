...
export function CheckinModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg rounded-2xl border border-base-300 bg-base-100 shadow-2xl">
        <div className="border-b border-base-300 px-6 py-4">
          <h3 className="text-lg font-semibold">Iniciar CheckIN</h3>
        ...
        <div className="flex gap-3 border-t border-base-300 px-6 py-4">
