...
- MemPalace MCP no projeto: wing `chekai` (rooms: `architecture`, `decisions`, `ux-patterns`, `bugs`, `features`, `platform-parity`); protocolo de uso em `.cursor/rules/mempalace.mdc` para memória persistente entre sessões
